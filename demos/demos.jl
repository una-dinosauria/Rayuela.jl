...
run_demos_query_base("MNIST",   Int(60e3), 16, 256, 50)
run_demos_query_base("labelme", Int(20e3), 16, 256, 50)
run_demos_query_base("MNIST",   Int(60e3), 8,  256, 50)
run_demos_query_base("labelme", Int(20e3), 8,  256, 50)
